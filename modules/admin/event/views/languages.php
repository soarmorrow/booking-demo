							...
							<tbody>
								...
								foreach ($languages as $value) {
									...
									<tr id="type<?= $value->id ?>">
										...
										<td>  <span class="desp_name"><?= $value->language ?></span></td>
										<td>                                                                                                                                                    
											<span data-link="<?php echo site_url('event/delete_language/'  . $value->id) ?>" data-namevalue="<?= $value->language ?>" data-id="<?= $value->id ?>" class="deletetype btn btn-sm btn-danger" title="archive">
