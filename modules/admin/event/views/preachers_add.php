                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    ?>">
                                        ...
                                        <textarea name="description" placeholder="Description" required class="form-control" value=""><?= $userpostedarray['description'] ?></textarea>
                                    ...
                                    ?>">
                                        ...
                                        <select name="language[]" multiple="multiple" class="form-control">
                                            ...
                                            <?php
                                            $languarray = explode(',', $userpostedarray['language']);
                                    ...
                                    ?>">
                                        ...
                                        <select name="preacher_status" class="form-control">
                                            ...
                                            foreach ($status as $value) {
                                                ?>
                                                <option value="<?= $value->id ?>" <?= $userpostedarray['status'] == $value->id ? 'selected' : '' ?>><?= $value->status ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    ?>">
                                        ...
                                        <textarea name="address" placeholder="Address" required class="form-control" value=""><?= $userpostedarray['address'] ?></textarea>
                                    ...
                                    ?>">
                                        ...
                                        <select name="expertise[]" multiple="multiple" class="form-control">
                                            ...
                                            <?php
                                            $expertisearray = explode(',', $userpostedarray['areas_of_expertise']);
                                            foreach ($expertise as $value) {
                                                ?>
                                                <option value="<?= $value->id ?>" <?= in_array($value->id, $expertisearray) ? 'selected' : '' ?>><?= $value->area_of_expertise ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
