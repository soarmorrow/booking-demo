...
<!--                                                <a href="<?php // echo site_url('event/view/' . $value->id) ?>" class="btn btn-sm btn-primary" title="view">
                                                ...
                                                <a href="<?= site_url('event/add_preacher_to_center/'. $value->id ) ?>" class="editimage btn btn-sm bg-green" title="Add">
        ...
        $('.editimage').click(function(e){
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result === '1') {
                        swal("Success!", 'Preacher Added succesfully, Waiting for Admin approval', "success");
                        me.closest('tr').remove();
                    } else {swal("Error!", 'Failed to add', "error");
                    }
                }
            });
        });
