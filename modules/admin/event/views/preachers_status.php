...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Preacher Status</li>
	</ol>
</section>
			...
			<div class="col-md-12">    
				<div class="box box-primary">
					<div class="box-header">
						<h3 class="box-title">Add New Preacher status</h3>
					</div><!-- /.box-header -->
					<div class="box-body">
						<div class="row">
							...
							<tbody>
								...
								foreach ($status as $value) {
									...
									<tr id="type<?= $value->id ?>">
										...
										<td>  <span class="desp_name"><?= $value->status ?></span></td>
										<td>                                                                                                                                                    
											<span data-link="<?php echo site_url('event/delete_status/'  . $value->id) ?>" data-namevalue="<?= $value->status ?>" data-id="<?= $value->id ?>" class="deletetype btn btn-sm btn-danger" title="archive">
