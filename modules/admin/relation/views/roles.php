                            ...
                            <div class="col-md-12">
                                <form name="" method="post" action="">
                                    <div class="input-group">
                                        <input type="text" name="name" class="form-control" required placeholder="New Role name here">
                                    ...
                                    if ($value->name != "GR Admin") {
                                        ...
                                        <tr id="type<?= $value->id ?>">
                                            ...
                                            <td> 
                                                ...
                                                <span data-link="<?php echo site_url('relation/delete_role/' . $value->id) ?>" data-namevalue="<?= $value->name ?>" data-id="<?= $value->id ?>" class="deletetype btn btn-sm btn-danger" title="archive">
...
<script>
    $(window).load(function () {
        ...
        $("#update_type").click(function () {
            ...
            $.ajax({
                url: "<?= site_url('relation/update_role') ?>",
                method: "post",
            ...
            function () {
                $.ajax({
                    ...
                    success: function (result) {
                        if (result === '1') {
                            $("#type" + id).remove();
                            swal("Archived!", "Role '" + name + "' archived successfully.", "success");
                        } else {
