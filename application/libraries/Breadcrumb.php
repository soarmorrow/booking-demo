...
class Breadcrumb
{
     ...
     * @return	void
     */
    function append_crumb($title, $href = '#', $ajax = true)
    {
        ...
        // add to end
        $this->breadcrumbs[] = array('title' => $title, 'href' => $href, 'ajax' => $ajax);
    }
...
//                    $output .= $this->_divider;
                ...
                {
                    $output .= '<a href="' . $crumb['href'] . '">' . $crumb['title'] . '</a> <span class="divider">/</span>';
                }
            }
    ...
    function display($theme_path)
    {
        if ($this->breadcrumbs)
        {
            ...
            foreach ($this->breadcrumbs as $key => $crumb)
            {
                ...
                {
//                    $output .= $crumb['ajax'] ? '<li><a href="' . $crumb['href'] . '" class="backable_link" getlink="' . $crumb['href'] . '" >' . $crumb['title'] . '</a>' : '<li><a href="' . $crumb['href'] . '" >' . $crumb['title'] . '</a>';
                }
            }
